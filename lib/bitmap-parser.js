...
let bmParser = (bufferData, cb) =>{  
  ...
  bitmap.dibHeader.rowLength = Math.floor( (bitmap.dibHeader.bpp * bitmap.dibHeader.width + 31) / 32) * 4
  bitmap.dibHeader.imgSize = bitmap.dibHeader.rowLength * Math.abs(bitmap.dibHeader.height)
